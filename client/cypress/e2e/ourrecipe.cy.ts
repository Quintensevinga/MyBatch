describe('Our Recipes', () => {
  it('renders everything on the page', () => {
    ...
    cy.contains('A rich and dark beer with flavors of roasted malt, coffee, and chocolate, balanced bitterness, and a creamy mouthfeel.').should(
      'be.visible'
    );
    ...
    cy.contains('Mash the Pale Malt, Roasted Barley, Chocolate Malt, and Black Patent Malt with hot water at 67°C for 60 minutes.').should(
      'be.visible'
    );
